...
export default function Laporan() {
  ...
  if (
    moment.utc("2023-06-12T17:00:00Z").isSame(moment.utc("2023-06-12"), "day")
  ) {
    ...
    <MainLayout>
      <div className="flex mx-12 my-14 space-x-4">
          ...
          <div>
            ...
            <div className="text-base mb-4">
              ...
              <p className="font-normal">
                {moment
                  .utc(detailMahasiswa.tanggal_mulai)
                  .format("DD MMMM YYYY")}
              </p>
            </div>
            <div className="text-base">
              ...
              <p className="font-normal">
                {moment
                  .utc(detailMahasiswa.tanggal_berakhir)
                  .format("DD MMMM YYYY")}
              </p>
            </div>
          </div>
        ...
        <div className="w-4/6 rounded-md border border-neutral-02 shadow-md px-6 py-5 font-normal">
          ...
          <div>
            <h6 className="text-darkblue-04 font-bold">Laporan Mingguan</h6>
            <div className="overflow-y-scroll max-h-60">
              {progressMingguan.map((data, index) => (
                <>
                  ...
                  <div
                    className={`rounded-md border border-neutral-02 shadow-md px-6 py-5 mb-3 ${
                      moment
                        .utc()
                        .startOf("day")
                        .isBefore(moment.utc(data.startWeek).startOf("day"))
                        ? "bg-neutral-02"
                        : ""
                    }`}
                  >
                    <div className="flex justify-between">
                      <span className="inline-flex items-center">
                        <span>
                          Minggu - {index + 1} :{" "}
                          <span className="">
                            {moment.utc(data.startWeek).format("DD MMMM YYYY")}{" "}
                            - {moment.utc(data.endWeek).format("DD MMMM YYYY")}
                          </span>{" "}
                        </span>
                      </span>
                          ...
                          <Button
                            ...
                            disabled={
                              moment
                                ...
                                .startOf("day")
                                .isBefore(
                                  moment.utc(data.startWeek).startOf("day")
                                )
                                ? true
                                : false
                            }
